...
def cameracrime(request):    
    path = './static/Criminals'
    images = []
    classNames = []
    myList = os.listdir(path)
    print(myList)
    ...
    def markAttendance(name):
        with open('./static/Criminals.csv', 'r+') as f:
            myDataList = f.readlines()
            nameList = []
            for line in myDataList:
                entry = line.split(',')
...
def cameraout(request):    
    ...
    def markAttendance(name):
        with open('./static/Attendanceout.csv', 'r+') as f:
            myDataList = f.readlines()
            nameList = []
            for line in myDataList:
                entry = line.split(',')
